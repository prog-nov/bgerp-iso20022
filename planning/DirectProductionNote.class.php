...
class planning_DirectProductionNote extends planning_ProductionDocument
{
    ...
    public function prepareEditForm_($data)
    {
        ...
        if(isset($rec->productId)){
            ...
            // Ако се произвежда етап, не може да се начисляват режийни разходи
            if($rec->productId != $jobRec->productId && cat_Products::haveDriver($rec->productId, 'planning_interface_StageDriver')){
                $form->setField('expenses', 'input=none');
            } else {
